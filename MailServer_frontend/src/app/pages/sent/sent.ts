  ...
  <app-sidebar
    ...
    (deleteFolder)="handleDeleteFolder($event)">
      ...
      <main class="flex-1 flex flex-col h-screen overflow-y-auto">
                ...
                <tr>
                  ...
                  <th class="py-3 pl-0 pr-4" colspan="4">
                    <div class="flex items-center w-full">
                      ...
                      <div class="px-4 text-slate-800 w-1/6 text-sm font-medium text-center whitespace-nowrap">
                        Date
                      </div>
                    </div>
                  </th>
        ...
        <div
          class="flex items-center justify-center p-4 border-t border-gray-200 bg-white mt-auto gap-2"
        >
          <button
            (click)="updatePage(page - 1)"
            class="flex items-center justify-center text-slate-500 hover:text-primary"
          >
            <span class="material-symbols-outlined text-lg">chevron_left</span>
          </button>
          <button
            *ngFor="let p of [0, 1, 2]; let i = index"
            (click)="updatePage(p)"
            [ngClass]="{
              'bg-primary text-white font-bold': page === p,
              'bg-slate-100 text-slate-600': page !== p
            }"
